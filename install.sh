...
install_XrayR() {
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/gocmodup/v2/main/XrayR.sh
    ...
    # Writing json
    echo "正在尝试写入配置文件..."
    wget https://raw.githubusercontent.com/gocmodup/v2/main/config.yml -O /etc/XrayR/config.yml
